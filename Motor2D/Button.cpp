...
Button::Button(uint _x, uint _y, SDL_Texture* _tex, bool _enabled, SDL_Rect* _anim, void(*Click)(), SDL_Rect* _hovered_anim, SDL_Rect* _pressed_anim) : Sprite(_x, _y, _tex, _enabled, _anim)
{
	type = BUTTON;
